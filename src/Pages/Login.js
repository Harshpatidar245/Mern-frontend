...
import loginIcons from "../Components/Assets/signin.gif";
...
const Login = () => {
  ...
  const handleOnChange = (e) => {
    // Corrected syntax
    const { name, value } = e.target; // Corrected variable name from 'password' to 'value'

    setData((preve) => ({
      // Corrected syntax for updating state
      ...preve,
      [name]: value,
    }));
  };
